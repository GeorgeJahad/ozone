...
public final class OzoneAclUtils {
  ...
  public static void checkAllAcls(OmMReader omMReader,
    ...
    if (omMReader.isNativeAuthorizerEnabled()) {
    ...
    // to Volume Owner.
    case VOLUME:
      omMReader.checkAcls(resType, storeType, aclType, vol, bucket, key,
    ...
    case PREFIX:
      omMReader.checkAcls(OzoneObj.ResourceType.VOLUME, storeType,
