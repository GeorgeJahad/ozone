...
public class OMSnapshotMoveDeletedKeysResponse extends OMClientResponse {
  ...
  protected void addToDBBatch(OMMetadataManager omMetadataManager,
    ...
    if (nextSnapshot != null) {
      RDBStore nextSnapshotStore = (RDBStore) nextSnapshot.getMetadataManager().getStore();
    ...
    RDBStore fromSnapshotStore = (RDBStore) fromSnapshot.getMetadataManager().getStore();
