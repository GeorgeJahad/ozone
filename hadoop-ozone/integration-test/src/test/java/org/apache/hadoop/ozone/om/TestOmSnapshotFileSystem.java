...
public class TestOmSnapshotFileSystem {
  ...
  public TestOmSnapshotFileSystem(BucketLayout newBucketLayout, boolean newEnableFileSystemPaths)
      throws Exception {
    ...
    if (TestOmSnapshotFileSystem.enabledFileSystemPaths != newEnableFileSystemPaths ||
